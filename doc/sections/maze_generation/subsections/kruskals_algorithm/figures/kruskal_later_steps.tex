\begin{figure}[H]
    ...
    \begin{subfigure}{0.3\textwidth}
        ...
        \begin{tikzpicture}[scale=0.75]
            ...
            \fill[gray] (1.1,1.1) rectangle ++(0.8, 0.8);
            ...
            \node at (1.5, 2.5) {\small\textbf{H}};
            \node at (2.5, 1.5) {\small\textbf{H}};
            \node at (0.5, 0.5) {\small\textbf{C}};
            \node at (0.5, 2.5) {\small\textbf{C}};
            \node at (1.5, 1.5) {\small\textbf{C}};
            ...
            \draw[dotted, line width=0.8mm] (0, 0) -- (0, 3);
            \draw[dotted, line width=0.8mm] (0, 0) -- (1, 0);
            \draw[dotted, line width=0.8mm] (0, 3) -- (1, 3);
            \draw[dotted, line width=0.8mm] (0.95, 3) -- (0.95, 2);
            \draw[dotted, line width=0.8mm] (0.95, 1) -- (0.95, 0);
            \draw[dotted, line width=0.8mm] (0.95, 2) -- (2, 2);
            \draw[dotted, line width=0.8mm] (2, 2) -- (2, 1);
            \draw[dotted, line width=0.8mm] (2, 1) -- (1, 1);

            \draw (0.5,1.5) circle[radius=4mm];
        \end{tikzpicture}
        \caption{\centering Komórka należąca do scalonego zbioru.}
    ...
    \begin{subfigure}{0.3\textwidth}
        ...
        \begin{tikzpicture}[scale=0.75]
            ...
            \draw[dashed, ultra thick] (2, 3) -- (3, 3);
            \draw[dashed, ultra thick] (4, 3) -- (5, 3);
            \draw[dashed, ultra thick] (2, 4) -- (3, 4);
            \draw[dashed, ultra thick] (4, 4) -- (5, 4);
            \draw[dashed, ultra thick] (3, 5) -- (4, 5);
            \draw[dashed, ultra thick] (3, 2) -- (4, 2);
            
            \draw[dashed, ultra thick] (2, 3) -- (2, 4);
            \draw[dashed, ultra thick] (5, 3) -- (5, 4);
            \draw[dashed, ultra thick] (3, 4) -- (3, 5);
            \draw[dashed, ultra thick] (3, 2) -- (3, 3);
            \draw[dashed, ultra thick] (4, 2) -- (4, 3);
            \draw[dashed, ultra thick] (4, 4) -- (4, 5);

            \draw (3.5,3.5) circle[radius=4mm];
        \end{tikzpicture}
        \caption{\centering Scalenie kolejnego osobnego zbioru.}
        \label{fig:kruskal_later_steps_c}
    \end{subfigure}
    \caption{\centering Przykładowe kolejne iteracje algorytmu. Utworzone zbiory oznaczono unikalnymi liniami.}
