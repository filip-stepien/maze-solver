...
\begin{enumerate}
    ...
    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_1}
    ...
    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_2}
    ...
    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_3}
    ...
    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_4}

    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_5}

    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_6}

    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_7}

    \input{sections/maze_generation/subsections/dfs_algorithm/figures/dfs_gen_step_8}
